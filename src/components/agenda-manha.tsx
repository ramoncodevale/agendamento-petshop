export const AgendaManha = () => {
  return (
   <>
    <section className="flex lg:hidden justify-center mt-8">
      <div className="bg-[#2E2C30] w-[350px] h-[180px] rounded-[10px] p-5">
    ...
    <section className="hidden lg:flex justify-center mt-8">
